package("simdjson-local")
    ...
    add_versions("v3.6.3", "afd8201cfb1abe927737d876441bb1f21730a9ee6078a1b8c6174e6463981fa3")
    ...
    on_install("windows|x64", "mingw|x86_64", "macosx|x86_64", "linux|x86_64", "linux|arm64", "linux|arm64-v8a", "iphoneos|arm64", function(package)
        local configs = {}
        if package:config("shared") then
            configs.kind = "shared"
        end
