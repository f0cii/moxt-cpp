package("snmalloc-local")
    ...
    add_versions("2023.11.27", "3c3739ddafa384da5c89984ec765a22af4d876a5")
    ...
    on_install("macosx", "windows", "mingw", "linux", "bsd", function (package)
        ...
        table.insert(configs, "-DSNMALLOC_ENABLE_DYNAMIC_LOADING=ON")
        table.insert(configs, "-DSNMALLOC_HEADER_ONLY_LIBRARY=ON")
