package("parallel-hashmap-local")
    ...
    add_urls("https://github.com/greg7mdp/parallel-hashmap/archive/refs/tags/v$(version).tar.gz",
        "https://github.com/greg7mdp/parallel-hashmap/archive/refs/tags/$(version).tar.gz",
    ...
    add_versions("1.3.11", "0515a681bfb24207013786a7737e9d8561302e656689d8a65ea480bbabab460f")
